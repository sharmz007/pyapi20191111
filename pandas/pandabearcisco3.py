...
def main():
    ...
    ciscodf.to_json("combined_ciscodata2.json", orient="records")

    ## export to csv
    ## do not include index number
    ciscodf.to_csv("combined_ciscodata2.csv", index=False)

    ## export to Excel
    ## do not include index number to xls
    ciscodf.to_excel("combined_ciscodata2.xls", index=False)
    ## do not include index number to xlsx
    ciscodf.to_excel("combined_ciscodata2.xlsx", index=False)
